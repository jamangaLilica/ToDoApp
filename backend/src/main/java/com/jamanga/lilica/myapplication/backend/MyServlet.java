...
package com.jamanga.lilica.myapplication.backend;
...
public class MyServlet extends HttpServlet {
    static Logger Log = Logger.getLogger("com.jamanga.lilica.myapplication.backend.MyServlet");
    @Override
    public void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        //Note: ensure that the [PRIVATE_KEY_FLLENAME].json has read
        //permissions set.
        FirebaseOptions options = new FirebaseOptions.Builder()
                .setServiceAccount(getServletContext().getResourceAsStream("WEB-INF/ToDoFirebaseProject-864544ab355d.json"))
                .setDatabaseUrl("https://todofirebaseproject-722ae.firebaseio.com/")
                .build();
        ...
        // As an admin, the app has access to read and wirte all data, regardless of Security Rules
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                // loading http://todofirebaseproject-722ae.appspot.com/send-email in your browser
                ...
                try {
                    ...
                    msg.setFrom(new InternetAddress("reminder@todofirebaseproject-722ae.appspotmail.com",
                            "Todo Reminder"));
                    msg.addRecipient(Message.RecipientType.TO,
                            new InternetAddress("jamanganet@gmail.com", "Recipient"));
